...
unzip(zipfile = "vdcr_parks.zip")
ogrListLayers("LocalParkInventory.gdb")
vcr_parks <- readOGR(dsn = "LocalParkInventory.gdb", layer = "Local_Park_Inventory_2018")
vcr_parks2 <- readOGR(dsn = "LocalParkInventory.gdb", layer = "Local_Park_Inventory")
